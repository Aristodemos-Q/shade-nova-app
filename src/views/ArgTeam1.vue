  ...
  <div class="mission mission--dimensions">
    <section class="mission__hero card surface-frosted">
      <div class="mission__hero-copy">
        ...
        <p>
          Ga naar het digibord op het leerplein en stap de digitale tweelingwereld binnen. Vind de vijf verschillen tussen de
    ...
    <section class="mission__panel card">
      ...
      <ul class="mission__list">
        <li><strong>Stap 1:</strong> Start het spel op het digibord in lokaal 2.10.</li>
