  ...
  <div class="mission mission--laser">
    <section class="mission__hero card surface-frosted">
      <div class="mission__hero-copy">
        ...
        <p>Ga naar lokaal 2.07 en ontwijk het lasersysteem. Leid de straal naar de juiste ontvanger en vind de ontsnappingscode.</p>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      steps: [
        "Welkom bij Laser Lockdown! Ga naar lokaal 2.07 om de missie te starten.",
